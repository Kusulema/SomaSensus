export const translations = {
  en: {
    ...
    booking: {
      ...
      availability: "Adala 1 (Mon-Fri, 17:00-20:00), Linnamae 37a (Sat-Sun, 10:00-16:00)",
      stebbyNote: "NB! Tickets are available via Stebby.",
      firstVisitDiscount: "First massage visit: 10% discount.",
      calendlyUrl: "https://calendly.com/yanabelova-massages/massage-physiotherapy-session?month=2026-04",
      openCalendar: "Book",
      form: { name: "Name", email: "Email", service: "Service", btn: "Book Now" }
    },
    welcomeSpace: {
      title: "Welcome to SomaSensus Space",
      text: "Step into a warm massage room designed not only for relaxation, but for full reset of body and mind. Soft lighting, calm aromas, and attentive care create the feeling that the outside world has finally gone quiet.",
      text2: "Each session is tailored to your current state: we release muscle tension, improve circulation, and help your nervous system return to balance. You leave not only with lighter muscles, but with clearer thoughts and deeper breathing.",
    ...
    offers: {
      ...
      items: [
        ...
        { id: 5, name: "Lymfodrinaz Massage", price: "60 min", icon: "", color: "green", desc: "A gentle technique to stimulate the lymphatic system.", benefits: ["Detox", "Immune support", "Reduced swelling", "Metabolism boost"] },
  ...
  ru: {
    ...
    booking: {
      ...
      locations: [
        ...
        { name: "Linnamäe 37a", prices: ["Лечебный массаж: 45/55€", "Спортивный массаж: 45/50€", "Классический массаж: 40/45€"] }
      ],
      availability: "Ädala 1 (E-R, 17-20), Linnamäe 37a (L-P, 10-16)",
      stebbyNote: "NB! Билеты доступны через Stebby.",
      firstVisitDiscount: "Первый визит на массаж - скидка 10%.",
      calendlyUrl: "https://calendly.com/yanabelova-massages/massage-physiotherapy-session?month=2026-04",
      openCalendar: "Записаться",
      form: { name: "Имя", email: "Email", service: "Услуга", btn: "Записаться" }
    },
    welcomeSpace: {
      title: "Пространство SomaSensus",
      text: "Добро пожаловать в пространство, где массаж — это не просто процедура, а полноценное восстановление тела и нервной системы. Здесь продумано все: мягкий свет, спокойная атмосфера и бережный подход к каждому запросу.",
    ...
    offers: {
      ...
      items: [
        ...
        { id: 5, name: "Лимфодренаж массаж", price: "60 мин", icon: "", color: "green", desc: "Стимуляция лимфотока для вывода токсинов и снятия отечности.", benefits: ["Детокс", "Иммунитет", "Против отеков", "Ускорение метаболизма"] },
    ...
    contact: { 
      ...
      tagUs: "Отмечайте нас на ваших фото!",
  ...
  et: {
    ...
    booking: {
      ...
      locations: [
        { name: "Pelgulinna Tervisemaja", prices: ["Terapeutiline massaaž: 50/60€", "Spordi massaaž: 50/60€", "Klassikaline massaaž: 45/50€"] },
        { name: "Linnamäe 37a", prices: ["Terapeutiline massaaž: 45/55€", "Spordimassaaž: 45/50€", "Klassikaline massaaž: 40/45€"] }
      ],
      availability: "Adala 1 (E-R, 17:00-20:00), Linnamae 37a (L-P, 10:00-16:00)",
      stebbyNote: "NB! Piletid on saadaval Stebby kaudu.",
      firstVisitDiscount: "Esimene massaaživisiit -10%.",
      calendlyUrl: "https://calendly.com/yanabelova-massages/massage-physiotherapy-session?month=2026-04",
      openCalendar: "Broneeri / Book",
      form: { name: "Nimi", email: "E-post", service: "Teenus", btn: "Broneeri" }
    },
    welcomeSpace: {
      title: "SomaSensus Ruum",
      text: "See on koht, kus massaaž tähendab enamat kui lihtsalt lõõgastust. Rahulik valgus, hoolikalt loodud õhkkond ja personaalne lähenemine aitavad kehal pingetest vabaneda ning meelel rahuneda.",
      text2: "Iga seanss kohandatakse sinu enesetunde järgi: leevendame lihaspingeid, toetame liikuvust ja taastumist. Pärast külastust tunned end kergemalt, tasakaalukamalt ja energilisemalt.",
      videoPlaceholder: "Soma Sensus"
    },
    offers: {
